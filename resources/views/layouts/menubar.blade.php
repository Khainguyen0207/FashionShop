...
<ul class="list-menu">
    ...
    <div class="menu">
        ...
        <li>
            <a href="/User"><i class="fa-solid fa-circle-arrow-left"></i> Về giao diện shop</a>
        </li>
        <li>
            <a href="?logout" name="action" value="logout"><i class="fa-solid fa-arrow-right-from-bracket fa-flip-horizontal"></i> Đăng xuất</a>
        </li>
    </div>
