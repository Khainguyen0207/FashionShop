<ul class="list-menu">
    ...
    <div class="menu">
        ...
        <li>
            <a href="#setting" onclick="update()"><i class="fa-solid fa-gear"></i> Cài đặt</a>
        </li>
        <li>
