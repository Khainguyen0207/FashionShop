<ul class="list-menu">
    ...
    <div class="menu">
        ...
        <li>
            <a href="/admin/logout" name="action" value="logout"><i class="fa-solid fa-arrow-right-from-bracket fa-flip-horizontal"></i> Đăng xuất</a>
        </li>
    </div>
